# NativeX - app
NativeX Clone App using ReactNative, Express JS(back-end), and Mysql(database)
...
**Frontend:**
```
$ git clone https://github.com/akimabs/Nativex-Client
$ cd CariKostFinal
$ npm install
...
**Back-end:**
```
$ git clone https://github.com/akimabs/NativeX-API
$ cd nativex-api
$ npm install
```

## Support Us :)
* Hire Me https://www.linkedin.com/in/ahakimdul/
